...
Edição ou criação de arquivos com extensões _.md, _.txt, \*.rst gerenciais no diretório relativo ou subpastas conectadas de projeto, fora de pastas protegidas.
