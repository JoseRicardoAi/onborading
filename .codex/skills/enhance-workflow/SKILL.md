...
Pesquisa estratégica usando browsing/search e leitura de fontes disponiveis no Codex. Se pesquisa externa estiver indisponivel, registrar a limitacao e seguir com fontes locais/fornecidas pelo usuario.
...
| ---------------------------------------- | ------------------------------------------------ |
| Projeto novo detectado (greenfield)      | `.codex/workflows/greenfield-fullstack.md`       |
| Projeto existente detectado (brownfield) | `.codex/workflows/brownfield-fullstack.md`       |
| Enhancement focado em UI                 | `.codex/workflows/brownfield-ui.md`              |
| Enhancement com spec complexa            | `.codex/workflows/spec-pipeline.md`              |
| Execução do épico gerado                 | `.codex/workflows/epic-orchestration.md`         |
