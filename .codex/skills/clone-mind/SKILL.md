...
Executar pesquisa com a capacidade de browsing/search disponivel no Codex para avaliar disponibilidade de fontes.
...
1. **Invocar @victoria-viability-specialist**
   ...
   - Usar: browsing/search disponivel para verificar fontes disponíveis
...
2. **Invocar @research-specialist**
   ...
   - Usar: browsing/search + leitura de paginas para pesquisa real
...
| Necessidade                  | Codex/AIOX                         |
| ---------------------------- | ---------------------------------- |
| Pesquisa e leitura de fontes | Browsing/search disponivel + citacoes |
| Task por subagentes          | Instrucao sequencial por fase      |
| Scripts externos             | Logica inline no pipeline, salvo quando houver script local aprovado |
