...
3. Gerar `.aiox/config.yaml` + `.aiox/environment-report.json`
...
> **Vantagem AntiGravity:** Use `mcp_stitch_generate_screen_from_text` para gerar wireframes diretamente — capacidade exclusiva vs Antigravity CLI.
