---
name: governance
description: Pré-validação de operações críticas — equivalente aos PreToolUse Hooks do Antigravity CLI
---
...
`.antigravity/`, `docs/`, `outputs/`, `squads/`, `node_modules/`, `.git/`, `package.json`, `tsconfig.json`, `.env`, `README.md`
