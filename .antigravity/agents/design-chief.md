...
# Design Chief - Agente Autônomo Antigravity
...
| Keyword                    | Ferramenta Antigravity                 | Especialista   |
| -------------------------- | -------------------------------------- | -------------- |
| `ui-mockup` / `wireframe`  | `mcp_stitch_generate_screen_from_text` | @uma (aiox-ux) |
| `ui-edit` / `ui-refine`    | `mcp_stitch_edit_screens`              | @uma (aiox-ux) |
