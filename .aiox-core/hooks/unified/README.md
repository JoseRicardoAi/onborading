...
**Supported CLIs:** Antigravity Code, Gemini Code

---

## Overview

The Unified Hooks System provides a consistent interface for lifecycle hooks across different AI coding assistants (Antigravity Code, Gemini Code, future CLIs).

### Architecture

```
CLI-Specific Hooks (.antigravity/hooks/, .gemini/hooks/)
         ↓
...
| Unified Event | Antigravity Code | Gemini Code |
|---------------|-------------|-------------|
...
```
Antigravity Code PreCompact Event
         ↓
.antigravity/hooks/precompact-session-digest.cjs
         ↓
