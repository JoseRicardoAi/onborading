...
|------------|---------|------|----------|
| `evoluindocomia/aiox-antigravity` | Commons Clause | Public | Core framework, 11 agents, Quality Gates |
| `evoluindocomia/aiox-squads` | MIT | Public | ETL, Creator, MMOS-Mapper squads |
| `evoluindocomia/mcp-ecosystem` | Apache 2.0 | Public | Docker MCP, IDE configs, MCP presets |
| `evoluindocomia/mmos` | Proprietary + NDA | Private | MMOS Minds, DNA Mental |
| `evoluindocomia/certified-partners` | Proprietary | Private | Premium squads, partner portal |
...
│                                                                         │
│   evoluindocomia/aiox-antigravity        evoluindocomia/aiox-squads                   │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
│                                                                         │
│   evoluindocomia/mmos             evoluindocomia/certified-partners            │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
