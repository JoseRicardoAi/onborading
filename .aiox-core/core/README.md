...
> Central runtime module providing essential framework functionality for AIOX Antigravity.
...
The core module is automatically available within the AIOX Antigravity framework:
...
*AIOX Antigravity Core Module v2.0.0*
