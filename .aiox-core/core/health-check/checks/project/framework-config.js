 ...
 *
 * @module aiox-core/health-check/checks/project/framework-config
 * @version 1.0.0
...
const REQUIRED_CONFIGS = [
  { path: '.aiox-core', type: 'directory', description: 'AIOX core framework' },
  { path: '.antigravity', type: 'directory', description: 'Antigravity Code configuration' },
];
...
const RECOMMENDED_CONFIGS = [
  { path: '.aiox', type: 'directory', description: 'AIOX local configuration' },
  { path: '.antigravity/ANTIGRAVITY.md', type: 'file', description: 'Project instructions' },
