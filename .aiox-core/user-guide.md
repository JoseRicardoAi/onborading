# Guia do Usuário AIOX Antigravity

## Visão Geral

O AIOX Antigravity é um framework de desenvolvimento full stack orientado por agentes de IA que implementa uma metodologia ágil única. Este guia explica como usar o AIOX Antigravity de forma eficaz através de suas duas fases principais: **Planejamento** e **Desenvolvimento**.
...
- **Acesso a um agente de IA**: Antigravity, GPT-4, Gemini, ou similar

## Instalação e Configuração Inicial

### Instalando AIOX-Antigravity

O AIOX-Antigravity oferece instalação simplificada através de um instalador interativo completo.
...
```
🚀 AIOX-Antigravity Installation Wizard
...
💻 Select IDEs to Configure:
  ◉ Antigravity Code (.antigravity/commands/)
  ◉ Cursor (.cursor/rules/)
  ◯ Gemini CLI (.gemini/)
...
Se você está contribuindo para o AIOX-Antigravity em si:

```bash
# Clone o repositório
git clone https://github.com/evoluindocomia/aiox-antigravity
cd aiox-core
...
│
├── .antigravity/                       # ✅ Se Antigravity Code selecionado
│   └── commands/
│       └── AIOX/
...
- Para desenvolvedores contribuindo ao AIOX-Antigravity
...
O AIOX Antigravity usa uma abordagem de duas fases que separa planejamento estratégico de implementação tática:

### Fase 1: Planejamento (Interface Web)

Use o agente de IA na interface web (Antigravity.ai, ChatGPT, Gemini, etc.) para:
...
O agente **qa** do AIOX Antigravity inclui capacidades avançadas de arquitetura de testes:
...
### Configuração para Antigravity Code

1. **Automático**:
   - Arquivo `.antigravity/ANTIGRAVITY.md` é carregado automaticamente
...
O AIOX Antigravity permite configurar preferências técnicas que influenciam decisões dos agentes:
...
O AIOX-Antigravity impõe integridade de repositório através de um agente centralizado de DevOps.
...
*detect-repo
# Output:
# Repository: github.com/evoluindocomia/aiox-antigravity
...
O AIOX-Antigravity oferece três modos de desenvolvimento para acomodar diferentes níveis de habilidade e restrições de tempo.
...
Ao integrar AIOX Antigravity em projetos existentes:
...
O AIOX Antigravity inclui meta-agentes para orquestração:
...
O AIOX Antigravity suporta squads para domínios específicos:
...
### Suporte
- [GitHub Issues](https://github.com/evoluindocomia/aiox-antigravity/issues)
...
*AIOX Antigravity User Guide v2.0*
