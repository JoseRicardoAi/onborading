...
const { createSynapseCommand } = require('./commands/synapse');
...
function createProgram() {
  ...
  program
    ...
    .description('AIOX-Antigravity: AI-Orchestrated System for Full Stack Development')
    .addHelpText('after', `
Commands:
  ...
  synapse           Inspect and execute SYNAPSE without IDE hooks
...
`);
  ...
  // Add synapse command (Codex/CLI explicit runtime)
  program.addCommand(createSynapseCommand());
