...
// are measured during interactive Antigravity Code sessions.
//
...
function validate() {
  ...
  console.log('Implementation: ANTIGRAVITY.md guidance section (not programmatic hard limit)');
  console.log('Rationale: Antigravity Code manages Tool Search internally; guidance limits excessive use');
