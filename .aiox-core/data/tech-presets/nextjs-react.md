...
> Preset de arquitetura otimizado para desenvolvimento fullstack com Next.js e React, focado em máxima eficiência com Antigravity Code.
...
preset:
  ...
  version: 1.0.0
  description: 'Arquitetura otimizada para aplicações fullstack com Next.js 16+, React, TypeScript e padrões que maximizam a eficiência do Antigravity Code'
  technologies:
...
> **Critical:** Estes 5 patterns eliminam 95% dos bugs e permitem ao Antigravity Code trabalhar com máxima eficiência. São complementares e devem ser usados TODOS juntos.
...
**Why Antigravity Code Excels:**

- TypeScript enforces contracts at compile time
- Antigravity reads contract (50 lines) instead of implementation (2000 lines)
...
> Estratégias para minimizar consumo de tokens com Antigravity Code.
...
_AIOX Tech Preset - AIOX Antigravity Framework_
