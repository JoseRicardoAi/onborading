#!/bin/bash
# AIOX Agent/Squad Tracker for Antigravity Code Statusline
# Called via Antigravity Code UserPromptSubmit hook
#
# Detects @agent, /squad:command, /ns:agents:name activations
# Writes to ~/.antigravity/session-cache/ for statusline-script.js to read
#
...
const cacheDir = path.join(os.homedir(), '.antigravity', 'session-cache');
