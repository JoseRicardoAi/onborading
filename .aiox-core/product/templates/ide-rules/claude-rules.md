# AIOX Antigravity Development Rules for Antigravity Code

You are working with AIOX Antigravity, an AI-Orchestrated System for Full Stack Development.

<!-- AIOX-MANAGED-START: core-framework -->
## Core Framework Understanding

AIOX Antigravity is a meta-framework that orchestrates AI agents to handle complex development workflows. Always recognize and work within this architecture.
...
O AIOX usa um modelo de 4 camadas (L1-L4) para separar artefatos do framework e do projeto. Deny rules em `.antigravity/settings.json` reforçam isso deterministicamente.
...
> **Referência formal:** `.antigravity/settings.json` (deny/allow rules), `.antigravity/rules/agent-authority.md`
<!-- AIOX-MANAGED-END: framework-boundary -->

<!-- AIOX-MANAGED-START: rules-system -->
## Rules System

O AIOX carrega regras contextuais de `.antigravity/rules/` automaticamente. Regras com frontmatter `paths:` só carregam quando arquivos correspondentes são editados.
...
| `agent-memory-imports.md` | Agent memory lifecycle and ANTIGRAVITY.md ownership |
...
> **Diretório:** `.antigravity/rules/` — rules são carregadas automaticamente pelo Antigravity Code quando relevantes.
...
## Antigravity Code Specific Configuration
...
---
*AIOX Antigravity Antigravity Code Configuration v2.0*
