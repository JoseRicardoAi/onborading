...
- [ ] Recommended actions (e.g., "elevate pattern X to .antigravity/rules/")
...
|---------|----------------|--------|
| "NEVER push — delegate to @devops" | dev, qa, analyst, sm, data-engineer, ux | Promote to `.antigravity/rules/` |
| CommonJS module system | dev, analyst, sm, data-engineer, ux, architect | Already in ANTIGRAVITY.md |
| Conventional commits format | dev, qa, devops, analyst, sm, data-engineer, ux | Already in ANTIGRAVITY.md |
| kebab-case for files | dev, analyst, sm, data-engineer, ux | Already in ANTIGRAVITY.md |
