 ...
 * @constant {string}
 */
const AIOX_SQUADS_REPO = 'evoluindocomia/aiox-squads';
...
class SquadPublisher {
   ...
   * @param {string} [options.repo] - Target repository (default: evoluindocomia/aiox-squads)
   */
  constructor(options = {}) {
...
---
*Submitted via \`*publish-squad\` from AIOX-Antigravity*`;
  }
