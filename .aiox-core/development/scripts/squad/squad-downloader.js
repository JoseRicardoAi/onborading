 ...
 */
const REGISTRY_URL =
  'https://raw.githubusercontent.com/evoluindocomia/aiox-squads/main/registry.json';
...
const GITHUB_API_BASE =
  'https://api.github.com/repos/evoluindocomia/aiox-squads/contents/packages';
    ...
    if (registry.squads && registry.squads.official) {
      for (const squad of registry.squads.official) {
        squads.push({
          ...
          type: 'official',
          author: squad.author || 'evoluindocomia',
        });
      }
    }
