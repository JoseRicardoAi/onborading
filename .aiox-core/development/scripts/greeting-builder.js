...
class GreetingBuilder {
   ...
   * Story ACT-12: Language removed — delegated to Antigravity Code native settings.json
   * @private
   * @param {Object} agent - Agent definition
   ...
   * ACT-12: Language removed — Antigravity Code handles translation natively via settings.json
   * @param {Object} agent - Agent definition
  ...
  buildPresentation(agent, sessionType, permissionBadge = '', sectionContext = null) {
    ...
    // ACT-12: Language delegated to Antigravity Code settings.json — hardcoded English phrases
    let greeting;
