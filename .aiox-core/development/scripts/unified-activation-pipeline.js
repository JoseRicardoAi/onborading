 ...
 * - Language handling delegated to Antigravity Code's native `language` setting in settings.json
...
// NOG-18: loadProjectStatus removed — gitStatus is native in Antigravity Code system prompt.
 ...
 * Language handling is delegated to Antigravity Code's native `language` setting in settings.json.
 * @type {string}
 */
...
class UnifiedActivationPipeline {
  ...
  async _runPipeline(agentId, options = {}, coreConfig = {}, startTime = Date.now()) {
    ...
    // NOG-18: projectStatus loader removed — gitStatus is native in Antigravity Code system prompt.
   ...
   * ACT-12: Language delegated to Antigravity Code native settings.json.
   * @private
   * @param {string} agentId - Agent ID
   ...
   * ACT-12: Language delegated to Antigravity Code native settings.json.
   * Fallback is English-only safety net — Antigravity Code translates natively.
   * @private
   * @param {string} agentId - Agent ID
...
module.exports = {
  ...
  // ACT-12: Single English fallback (language delegated to Antigravity Code settings.json)
  FALLBACK_PHRASE,
};
