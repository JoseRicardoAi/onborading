...
This directory contains workflow definitions for the AIOX Antigravity framework. Workflows define multi-step processes that can be executed by AIOX agents.
...
### IDE Rule Locations
- **Cursor**: `.cursorules`
- **Antigravity Code**: `.antigravity/ANTIGRAVITY.md`
