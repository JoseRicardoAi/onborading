...
post-conditions:
  ...
  - [ ] Branch exists
    tipo: post-condition
    blocker: true
    validação: Branch auto-antigravity/{storyId} exists
...
acceptance-criteria:
  ...
  - [ ] Branch follows naming convention auto-antigravity/{storyId}
    tipo: acceptance-criterion
    blocker: true
...
- Enable Auto-Antigravity to develop stories autonomously
...
⚠️  Worktree for '{storyId}' already exists.
    ...
    Branch: auto-antigravity/{storyId}
...
interface WorktreeInfo {
  ...
  branch: string; // 'auto-antigravity/STORY-42'
...
- [ ] Git branch `auto-antigravity/{storyId}` exists
...
git branch -d auto-antigravity/{storyId}
```
