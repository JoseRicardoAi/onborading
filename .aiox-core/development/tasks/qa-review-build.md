...
subphases:
  # Phase 1.2: Evidence Requirements (Absorbed from Auto-Antigravity)
  - id: 1.2
...
subphases:
  # Phase 4.2: Browser Console Check (Absorbed from Auto-Antigravity)
  - id: 4.2
...
subphases:
  # Phase 5.3: False Positive Detection (Absorbed from Auto-Antigravity)
  - id: 5.3
...
### Phase 6: Code Review (Enhanced with Auto-Antigravity Absorption)
...
# Phase 6.0: Library Validation (Absorbed from Auto-Antigravity)
subphases:
  - id: 6.0
  ...
  # Phase 6.1: Security Checklist (Absorbed from Auto-Antigravity)
  - id: 6.1
  ...
  # Phase 6.2: Migration Validation (Absorbed from Auto-Antigravity)
  - id: 6.2
