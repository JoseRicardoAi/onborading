...
📋 Loading sync configuration...
   Active IDEs: antigravity, cursor
...
Step 2: Syncing to Antigravity CLI
   ✓ .antigravity/commands/Legal/agents/legal-chief.md
   ✓ .antigravity/commands/Legal/agents/brad-feld.md
   ✓ .antigravity/commands/Legal/agents/ken-adams.md
   ✓ .antigravity/commands/Legal/agents/pierpaolo-bottini.md
   ✓ .antigravity/commands/Legal/agents/tributarista.md
   ✓ .antigravity/commands/Legal/agents/trabalhista.md
   ✓ .antigravity/commands/Legal/agents/societarista.md
   ✓ .antigravity/commands/Legal/agents/lgpd-specialist.md
   ✓ .antigravity/commands/Legal/tasks/revisar-contrato.md
...
🚀 Commands available:
   /Legal:agents:legal-chief (Antigravity CLI)
...
sync_mappings:
  squad_agents:
    ...
    destinations:
      antigravity:
        - path: '.antigravity/commands/{squad_alias}/agents/'
          format: 'md'
      cursor:
        - path: '.cursor/rules/'
          format: 'mdc'
...
| Diretório       | Alias   | Comando Antigravity              |
| --------------- | ------- | --------------------------- |
...
│     │                                             │
│     ├── Antigravity: Copy MD → .antigravity/commands/       │
...
- Antigravity: `.antigravity/commands/{SquadAlias}/agents/{name}.md`
...
- Antigravity: `.antigravity/commands/{SquadAlias}/tasks/{name}.md`
...
- Antigravity: `.antigravity/commands/{SquadAlias}/workflows/{name}.yaml`
...
const activeIdes = syncConfig.active_ides || ['antigravity'];
...
- `*sync-squad-antigravity` - Sincronizar para Antigravity marketplace
