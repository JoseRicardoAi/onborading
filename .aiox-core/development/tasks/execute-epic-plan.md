...
- **Tool:** Task tool (Antigravity CLI built-in)
  - **Purpose:** Spawn subagents for story development-cycle and wave gates
  - **Source:** Antigravity CLI runtime

- **Tool:** Read tool (Antigravity CLI built-in)
  - **Purpose:** Read execution plan, story files, workflow templates
  - **Source:** Antigravity CLI runtime

- **Tool:** Write tool (Antigravity CLI built-in)
  - **Purpose:** Persist epic state file
  - **Source:** Antigravity CLI runtime

- **Tool:** AskUserQuestion (Antigravity CLI built-in)
  - **Purpose:** Wave checkpoints (GO/PAUSE/REVIEW/ABORT)
  - **Source:** Antigravity CLI runtime

- **Tool:** Bash (Antigravity CLI built-in)
...
The state file persists on disk. To resume in a new Antigravity CLI session:
