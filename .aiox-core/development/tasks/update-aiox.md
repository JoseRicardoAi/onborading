...
1. **Clone upstream** - Sparse shallow clone of evoluindocomia/aiox-antigravity (only `.aiox-core/`)
...
| `ANTIGRAVITY.md` | Project rules |
| `.antigravity/commands/` | Custom commands |
