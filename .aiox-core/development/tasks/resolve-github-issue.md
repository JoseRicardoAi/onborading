...
steps:
  1_implement_changes:
    ...
    rules:
      - Follow project conventions (ANTIGRAVITY.md)
  ...
  3_handle_edge_cases:
    ...
    known_pitfalls:
      - Email addresses inside strings may match rename patterns (Issue #159: security@evoluindocomia/aiox-core.dev)
...
steps:
  ...
  2_commit:
    ...
    format: |
      ...
      Co-Authored-By: Antigravity Opus 4.6 <noreply@anthropic.com>
    type_map:
      BUG: fix
      FEATURE: feat
      ENHANCEMENT: feat
...
- **Pitfall:** `@evoluindocomia/aiox-core` inside email `security@evoluindocomia/aiox-core.dev` was corrupted
