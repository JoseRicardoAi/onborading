 ...
 * @property {string} branch - Branch name (auto-antigravity/{storyId})
 ...
 * @property {string} [branchPrefix='auto-antigravity/'] - Prefix for worktree branches
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.branchPrefix = options.branchPrefix || 'auto-antigravity/';
  ...
  async list() {
    ...
    for (const block of blocks) {
      ...
      // Skip main worktree and non-auto-antigravity worktrees
