 ...
 * - AC2: Máximo 5 iterações (configurável via autoAntigravity.qaLoop.maxIterations)
...
const CONFIG = {
  ...
  configPath: 'autoAntigravity.qaLoop.maxIterations',
    ...
    for (const configPath of configPaths) {
      if (fs.existsSync(configPath)) {
        try {
          ...
          // Navigate to autoAntigravity.qaLoop.maxIterations
          const value = config?.autoAntigravity?.qaLoop?.maxIterations;
