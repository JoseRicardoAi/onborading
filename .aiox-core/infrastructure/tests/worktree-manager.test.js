...
describe('WorktreeManager', () => {
  ...
  describe('constructor', () => {
    it('should use default options when none provided', () => {
      ...
      expect(defaultManager.branchPrefix).toBe('auto-antigravity/');
  ...
  describe('getBranchName', () => {
    it('should return correct branch name for story', () => {
      ...
      expect(branch).toBe('auto-antigravity/STORY-42');
    });
  });
  ...
  describe('create', () => {
    it('should create worktree with correct structure', async () => {
      try {
        ...
        expect(info.branch).toBe('auto-antigravity/STORY-42');
  ...
  describe('formatList', () => {
    ...
    it('should format worktrees correctly', () => {
      ...
      expect(output).toContain('auto-antigravity/STORY-42');
  ...
  describe('mergeToBase', () => {
    ...
    it('should merge worktree successfully', async () => {
      try {
        ...
        expect(result.sourceBranch).toBe('auto-antigravity/STORY-42');
