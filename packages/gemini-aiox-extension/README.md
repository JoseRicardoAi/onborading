...
Brings AIOX Antigravity multi-agent orchestration to Gemini CLI.

## Installation

```bash
gemini extensions install github.com/antigravity/aiox-core/packages/gemini-aiox-extension
```
...
AIOX skills work identically in both Antigravity and Gemini CLI. Same agents, same commands, same format.
