...
const TROUBLESHOOTING_DATABASE = {
  ENV_FILE_MISSING: {
    ...
    solutions: [
      'Re-run wizard: npx @evoluindocomia/aiox@latest init',
      'Manually create .env from template: cp .env.example .env',
      'Check file permissions in project directory',
    ],
    docs: 'https://docs.evoluindocomia.com/installation/environment',
    priority: 'critical',
  },
  ...
  CORE_CONFIG_MISSING: {
    ...
    docs: 'https://docs.evoluindocomia.com/configuration/core-config',
    priority: 'high',
  },
  ...
  MCP_HEALTH_CHECK_FAILED: {
    ...
    docs: 'https://docs.evoluindocomia.com/mcps/troubleshooting',
    priority: 'medium',
  },
  ...
  GITIGNORE_CRITICAL_MISSING: {
    ...
    docs: 'https://docs.evoluindocomia.com/security/gitignore',
    priority: 'high',
  },
  ...
  DEPS_INSTALL_FAILED: {
    ...
    docs: 'https://docs.evoluindocomia.com/installation/dependencies',
    priority: 'critical',
  },
  ...
  ENV_PERMISSIONS_INSECURE: {
    ...
    docs: 'https://docs.evoluindocomia.com/security/file-permissions',
    priority: 'medium',
  },
};
...
async function offerTroubleshooting(errors) {
  ...
  if (openDocs) {
    ...
    console.log(chalk.green('  https://docs.evoluindocomia.com/troubleshooting'));
    console.log('');
  }
  ...
  console.log(chalk.dim('  - GitHub Issues: https://github.com/evoluindocomia/aiox/issues'));
  console.log(chalk.dim('  - Documentation: https://docs.evoluindocomia.com'));
  console.log('');
}
