...
const TRANSLATIONS = {
  en: {
    ...
    tryAgain: 'Run `npx aiox-antigravity init` to try again.',
    ...
    proPurchase: 'Purchase Pro: https://pro.antigravity.ai',
    ...
    proContactSupportEmail: 'Or open an issue: https://github.com/evoluindocomia/aiox-antigravity/issues',
    ...
    proPurchaseAt: 'Purchase Pro at https://pro.antigravity.ai',
    ...
    proModuleNotAvailable: 'Pro license module not available. Ensure @aiox-antigravity/pro is installed.',
    proModuleBootstrap: 'Pro license module not found locally. Installing @aiox-antigravity/pro to bootstrap...',
    ...
    proInstallingPackage: 'Installing @aiox-antigravity/pro...',
    proPackageInstalled: 'Pro package installed',
    proPackageInstallFailed: 'Failed to install Pro package',
    proScaffolderNotAvailable: 'Pro scaffolder not available. Ensure @aiox-antigravity/pro is installed.',
    ...
    proNpmInstallFailed: 'npm install @aiox-antigravity/pro failed: {message}. Try manually: npm install @aiox-antigravity/pro',
  },
  ...
  pt: {
    ...
    tryAgain: 'Execute `npx aiox-antigravity init` para tentar novamente.',
    ...
    proPurchase: 'Comprar Pro: https://pro.antigravity.ai',
    ...
    proContactSupportEmail: 'Ou abra uma issue: https://github.com/evoluindocomia/aiox-antigravity/issues',
    ...
    proPurchaseAt: 'Compre o Pro em https://pro.antigravity.ai',
    ...
    proModuleNotAvailable: 'Módulo de licença Pro não disponível. Certifique-se de que @aiox-antigravity/pro está instalado.',
    proModuleBootstrap: 'Módulo de licença Pro não encontrado localmente. Instalando @aiox-antigravity/pro...',
    ...
    proInstallingPackage: 'Instalando @aiox-antigravity/pro...',
    proPackageInstalled: 'Pacote Pro instalado',
    proPackageInstallFailed: 'Falha ao instalar pacote Pro',
    proScaffolderNotAvailable: 'Scaffolder Pro não disponível. Certifique-se de que @aiox-antigravity/pro está instalado.',
    ...
    proNpmInstallFailed: 'npm install @aiox-antigravity/pro falhou: {message}. Tente manualmente: npm install @aiox-antigravity/pro',
  },
  ...
  es: {
    ...
    tryAgain: 'Ejecute `npx aiox-antigravity init` para intentar nuevamente.',
    ...
    proContactSupportEmail: 'O abra un issue: https://github.com/evoluindocomia/aiox-antigravity/issues',
    ...
    proPurchaseAt: 'Compre Pro en https://pro.antigravity.ai',
    ...
    proModuleNotAvailable: 'Módulo de licencia Pro no disponible. Asegúrese de que @aiox-antigravity/pro esté instalado.',
    proModuleBootstrap: 'Módulo de licencia Pro no encontrado localmente. Instalando @aiox-antigravity/pro...',
    ...
    proScaffolderNotAvailable: 'Scaffolder Pro no disponible. Asegúrese de que @aiox-antigravity/pro esté instalado.',
    ...
    proNpmInstallFailed: 'npm install @aiox-antigravity/pro falló: {message}. Intente manualmente: npm install @aiox-antigravity/pro',
  },
};
