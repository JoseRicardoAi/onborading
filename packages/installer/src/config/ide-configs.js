 ...
 * IDE Configuration Metadata
 *
 * AIOX Antigravity v4 supports 6 main IDEs:
 * - Antigravity Code (Anthropic's official CLI) - Recommended
...
const IDE_CONFIGS = {
  codex: {
    name: 'Codex CLI',
    description: 'OpenAI Codex CLI with AGENTS.md, local .codex agents, and project-local skills',
    ...
    skillsFolder: path.join('.codex', 'skills'),
    specialConfig: {
      type: 'codex',
      rootDoc: path.join('.codex', 'CODEX.md'),
      rulesFolder: path.join('.codex', 'rules'),
      skillsFolder: path.join('.codex', 'skills'),
    },
  },
  gemini: {
    name: 'Gemini CLI',
    description: 'Google Gemini CLI with AIOX rules, slash launchers, and hooks',
  ...
  cursor: {
    name: 'Cursor',
    description: 'Cursor IDE rules for AIOX agents',
  ...
  'github-copilot': {
    name: 'GitHub Copilot',
    description: 'GitHub Copilot chat mode and agent files',
  ...
  antigravity: {
    name: 'AntiGravity',
    description: 'Google AntiGravity agentic platform configuration',
