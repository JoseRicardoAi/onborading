/**
 * AIOX Color Palette v4.0.4
 * 
 * Brand-inspired color system for CLI tools and terminal output.
 * Colors derived from AIOX logo gradient (magenta → orange → purple → blue)
...
const colors = {
   ...
   * Matches AIOX logo gradient: magenta → purple → blue
   */
  gradient: {
  ...
  /**
   * Primary branding - Bold purple for AIOX brand moments
   */
