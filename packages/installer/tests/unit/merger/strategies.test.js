...
describe('getMergeStrategy', () => {
  ...
  it('should return MarkdownMerger for .md files', () => {
    const merger = getMergeStrategy('ANTIGRAVITY.md');
  ...
  it('should handle paths with directories', () => {
    const merger = getMergeStrategy('/path/to/.antigravity/rules.md');
    expect(merger).toBeInstanceOf(MarkdownMerger);
  });
});
...
describe('hasMergeStrategy', () => {
  ...
  it('should return true for .md files', () => {
    expect(hasMergeStrategy('ANTIGRAVITY.md')).toBe(true);
  });
