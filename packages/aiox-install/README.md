# @evoluindocomia/aiox-antigravity-install
...
```bash
npx @evoluindocomia/aiox-antigravity-install
```
...
```bash
npx @evoluindocomia/aiox-antigravity-install --help
...
```bash
npx @evoluindocomia/aiox-antigravity-install --dry-run
```
...
```bash
npx @evoluindocomia/aiox-antigravity-install --profile bob
npx @evoluindocomia/aiox-antigravity-install --profile advanced
```
...
- Documentation: https://github.com/evoluindocomia/aiox-antigravity
- Issues: https://github.com/evoluindocomia/aiox-antigravity/issues
