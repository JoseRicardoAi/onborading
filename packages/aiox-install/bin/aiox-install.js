 ...
 *
 * Usage:
 *   npx @evoluindocomia/aiox-antigravity-install          # Interactive installation
 *   npx @evoluindocomia/aiox-antigravity-install --dry-run # Preview what would be done
 *   npx @evoluindocomia/aiox-antigravity-install --version # Show version
 *
 * @package @evoluindocomia/aiox-antigravity-install
 */
