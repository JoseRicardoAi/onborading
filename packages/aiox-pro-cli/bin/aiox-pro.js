 ...
 * aiox-pro CLI
 *
 * Thin CLI wrapper for @aiox-antigravity/pro.
 * Provides a clean npx interface: npx aiox-pro install
 *
 * Commands:
 *   install             Install @aiox-antigravity/pro in the current project
...
const PRO_PACKAGE = '@aiox-antigravity/pro';
...
function isProInstalled() {
  try {
    const pkgPath = path.join(process.cwd(), 'node_modules', '@aiox-antigravity', 'pro', 'package.json');
...
Documentation: https://antigravity.ai/pro/docs
`);
}
