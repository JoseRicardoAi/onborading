# AIOX Antigravity: Universal AI Agent Framework 🚀
...
[![CI](https://github.com/evoluindocomia/aiox-antigravity/actions/workflows/ci.yml/badge.svg)](https://github.com/evoluindocomia/aiox-antigravity/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/evoluindocomia/aiox-antigravity/branch/main/graph/badge.svg)](https://codecov.io/gh/evoluindocomia/aiox-antigravity)
[![Documentation](https://img.shields.io/badge/docs-available-orange.svg)](https://antigravity.ai)
...
- AntiGravity (Recommended): Activation via `@agent-name` shortcuts or files in `.antigravity/skills/`
- Gemini CLI: `/aiox-menu` → `/aiox-<agent>`
- Codex CLI: `/skills` → `aiox-<agent-id>`
- Cursor/Copilot: follow the limits and workarounds in `docs/ide-integration.md`
...
| IDE/CLI | Integration Parity | Practical Impact |
| --- | --- | --- |
| AntiGravity | Complete (Native v4 reference) | Maximum context automation, native parallel tool execution, WebP video via browser |
...
| Cursor | Different Architecture | Less pre/post tool automation; focus on rules, MCP, and agent flow |
| GitHub Copilot | No equivalent lifecycle events | Less session/tooling automation; focus on repository instructions |

Detailed impacts and mitigation: `docs/ide-integration.md`.

## Acknowledgments & Attribution

AIOX Antigravity was originally derived from the [BMad Method](https://github.com/bmad-code-org/BMAD-METHOD), created by [Brian Madison](https://github.com/bmadcode) (BMad Code, LLC). We gratefully acknowledge the BMad Method for providing the foundation from which this project began.
...
AIOX Antigravity follows a clear priority hierarchy:
...
**The Two Key Innovations of AIOX Antigravity:**
...
> ⚠️ **These diagrams explain 90% of the confusion about the AIOX Antigravity Agentic Agile workflow** - Understanding PRD+Architecture creation and the sm/dev/qa workflow and how agents pass notes through story files is essential - and it also explains why this is NOT taskmaster or just a simple task runner!
...
- **[Report issues](https://github.com/evoluindocomia/aiox-antigravity/issues)** → Bug reports and feature requests
...
**Install AIOX Antigravity with a single command:**
...
npx aiox-antigravity@latest init my-project
```

### ✨ Modern Installation Wizard

AIOX Antigravity now includes a cutting-edge interactive installation experience, inspired by modern tools like Vite and Next.js:
...
- ✅ Automatic IDE configuration (Codex CLI, Cursor, or Antigravity Code)
...
AIOX Antigravity includes pre-configured IDE rules to enhance your development experience:
...
- ✅ Native Integration in AIOX 4.2+ (Complete orchestration)
- Skills loaded from `.antigravity/skills/`
- Concurrent Tools architecture executed perfectly in skills
- ✅ Auto-recording of visual tests with WebP

#### For Antigravity Code (Legacy):

- The `.antigravity/ANTIGRAVITY.md` file is maintained as legacy
- Partial agent sync still available via `npm run sync:ide:antigravity`
...
1. **Install AIOX**: Run `npx aiox-antigravity init my-project`
2. **Configure your IDE**: Follow the setup instructions for Codex CLI, Cursor, or Antigravity Code
...
AIOX Antigravity offers a modern, cross-platform CLI with intuitive commands:

```bash
# Project Management (with interactive wizard)
npx aiox-antigravity init <project-name> [options]
...
npx aiox-antigravity install [options]
  --force              Overwrite existing configuration
  --quiet              Minimal output during installation
  --dry-run            Simulate installation without modifying files

# System Commands
npx aiox-antigravity --version   Display installed version
npx aiox-antigravity --help      Display detailed help
npx aiox-antigravity info        Display system information
npx aiox-antigravity doctor      Run system diagnostics
npx aiox-antigravity doctor --fix Automatically fix detected issues

# Maintenance
npx aiox-antigravity update      Update to latest version
npx aiox-antigravity uninstall   Remove AIOX Antigravity
```
...
✔ AIOX Antigravity installed successfully
```
...
git clone https://github.com/evoluindocomia/aiox-antigravity.git
cd aiox-core
...
The AIOX natural language framework works in ANY domain. Squads provide specialized AI agents for creative writing, business strategy, health and wellness, education, and more. Additionally, Squads can expand the AIOX Antigravity core with domain-specific functionality that isn't generic for all use cases. [See the Squads Guide](docs/guides/squads-guide.md) and learn to create your own!

## Available Agents

AIOX Antigravity comes with 12 specialized agents:
...
AIOX Antigravity introduces the **Autonomous Development Engine (ADE)** - a complete system for autonomous development that transforms requirements into working code.
...
| **2** | Migration V2→V3  | Migration to autoAntigravity V3 format          |
...
- **[hybrid-ops](https://github.com/evoluindocomia/aiox-hybrid-ops-pedro-valerio)** - Human-agent hybrid operations (separate repository)

## AIOX Pro

**AIOX Pro** (`@aiox-antigravity/pro`) is the premium module of AIOX Antigravity, offering advanced features for teams and larger-scale projects.

> **Restricted availability:** AIOX Pro is available exclusively to members of the **AIOX Cohort Advanced**. [Learn more about the program](https://antigravity.ai).
...
For more information, run `npx aiox-antigravity pro --help` after installation.

## Support

- 🐛 [Issue Tracker](https://github.com/evoluindocomia/aiox-antigravity/issues) - Bug reports and feature requests
...
AIOX Antigravity implements a multi-layer validation system to ensure code quality and consistency:
...
**Note:** Some contributors shown in the GitHub contributors graph are inherited from the original BMad Method git history and do not represent active participation in or endorsement of AIOX Antigravity.

[![Contributors](https://contrib.rocks/image?repo=evoluindocomia/aiox-antigravity)](https://github.com/evoluindocomia/aiox-antigravity/graphs/contributors)

<sub>Built with ❤️ for the AI-assisted development community</sub>

---

**[⬆ Back to top](#antigravity-aiox-universal-ai-agent-framework-)**
