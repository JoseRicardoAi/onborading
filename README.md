# Aiox-Antigravity: Framework Universal de Agentes IA 🚀

> 🌍 [English](README.en.md) | **[Português](README.md)**

[![Versão NPM](https://img.shields.io/npm/v/aiox-antigravity.svg)](https://www.npmjs.com/package/aiox-antigravity)
[![Licença: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Versão Node.js](https://img.shields.io/badge/node-%3E%3D18.0.0-brightgreen.svg)](https://nodejs.org/)
[![CI](https://github.com/evoluindocomia/antigravity-aiox-antigravity/actions/workflows/ci.yml/badge.svg)](https://github.com/evoluindocomia/antigravity-aiox-antigravity/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/AffHub/aiox-antigravity/branch/main/graph/badge.svg)](https://codecov.io/gh/AffHub/aiox-antigravity)
[![Documentação](https://img.shields.io/badge/docs-disponível-orange.svg)](https://antigravity.ai)
...
- AntiGravity (Recomendado): Ativação via atalhos `@agent-name` ou arquivos em `.antigravity/skills/`
- Gemini CLI: `/aiox-menu` → `/aiox-<agent>`
- Codex CLI: `/skills` → `aiox-<agent-id>`
- Cursor/Copilot: siga os limites e workarounds em `docs/ide-integration.md`
...
| IDE/CLI | Paridade de Integração | Impacto Prático |
| --- | --- | --- |
| AntiGravity | Completa (Referência nativa v4) | Automação máxima de contexto, execução paralela nativa de tools, vídeo WebP via browser |
...
| Cursor | Arquitetura diferente | Menor automação de pre/post tool; foco em regras, MCP e fluxo do agente |
| GitHub Copilot | Sem lifecycle events nativos | Menor automação de sessão/tooling; foco em instruções de repositório |

Impactos e mitigação detalhados: `docs/ide-integration.md`.

## Acknowledgments & Attribution

AffHub AIOX was originally derived from the [BMad Method](https://github.com/bmad-code-org/BMAD-METHOD), created by [Brian Madison](https://github.com/bmadcode) (BMad Code, LLC). We gratefully acknowledge the BMad Method for providing the foundation from which this project began.

**Important:** This project is **NOT affiliated with, endorsed by, or sanctioned by** the BMad Method or BMad Code, LLC. Contributors appearing in the git history from the original BMad Method repository do not imply active participation in or endorsement of Aiox-Antigravity.
...
O Aiox-Antigravity segue uma hierarquia clara de prioridades:
...
**As Duas Inovações Chave do Aiox-Antigravity:**
...
> ⚠️ **Estes diagramas explicam 90% da confusão sobre o fluxo AffHub AIOX Agentic Agile** - Entender a criação de PRD+Arquitetura e o fluxo de trabalho sm/dev/qa e como os agentes passam notas através de arquivos de histórias é essencial - e também explica por que isto NÃO é taskmaster ou apenas um simples executor de tarefas!
...
- **[Reportar problemas](https://github.com/evoluindocomia/antigravity-aiox-antigravity/issues)** → Bug reports e feature requests

## Importante: Mantenha Sua Instalação AIOX Atualizada

**Mantenha-se atualizado sem esforço!** Para atualizar sua instalação Aiox-Antigravity existente:

```bash
npx aiox-antigravity@latest install
```
...
**Instale o Aiox-Antigravity com um único comando:**
...
npx aiox-antigravity@latest init meu-projeto
```

### ✨ Assistente de Instalação Moderno

O Aiox-Antigravity agora inclui uma experiência de instalação interativa de última geração, inspirada em ferramentas modernas como Vite e Next.js:
...
- ✅ Configuração automática do IDE (Codex CLI, Cursor ou Antigravity Code)
...
O Aiox-Antigravity inclui regras pré-configuradas para IDE para melhorar sua experiência de desenvolvimento:
...
#### Para AntiGravity (Recomendado):

- ✅ Integração Nativa no AIOX 4.2+ (Orquestração completa)
- Skills lidas a partir de `.antigravity/skills/`
- Arquitetura de Concurrent Tools executada perfeitamente nas skills
- ✅ Auto-recording dos testes visuais com WebP

#### Para Antigravity Code (Legado):

- O arquivo `.antigravity/ANTIGRAVITY.md` é mantido por legado
- Parcial sync de agentes ainda disponível via `npm run sync:ide:antigravity`
...
1. **Instale o AIOX**: Execute `npx aiox-antigravity init meu-projeto`
2. **Configure seu IDE**: Siga as instruções de configuração para Codex CLI, Cursor ou Antigravity Code
...
O AffHub AIOX oferece uma CLI moderna e cross-platform com comandos intuitivos:

```bash
# Gerenciamento de Projeto (com assistente interativo)
npx aiox-antigravity init <nome-projeto> [opções]
...
npx aiox-antigravity install [opções]
...
# Comandos do Sistema
npx aiox-antigravity --version   Exibir versão instalada
npx aiox-antigravity --help      Exibir ajuda detalhada
npx aiox-antigravity info        Exibir informações do sistema
npx aiox-antigravity doctor      Executar diagnósticos do sistema
npx aiox-antigravity doctor --fix Corrigir problemas detectados automaticamente

# Manutenção
npx aiox-antigravity update      Atualizar para versão mais recente
npx aiox-antigravity uninstall   Remover AffHub AIOX
```
...
Next steps:
  ...
  aiox-antigravity doctor     # Verify installation
  aiox-antigravity --help     # See available commands
```
...
$ npx aiox-antigravity install --quiet --force
✔ AffHub AIOX installed successfully
```
...
$ npx aiox-antigravity install --dry-run

[DRY RUN] Would create: ./my-project/
[DRY RUN] Would copy: .aiox-antigravity/ (45 files)
...
Configuration:
✔ .aiox-antigravity/ directory exists
...
```bash
$ npx aiox-antigravity --help

Usage: aiox-antigravity [options] [command]

Aiox-Antigravity: AI-Orchestrated System for Full Stack Development
...
Run 'aiox-antigravity <command> --help' for detailed information about each command.
```
...
git clone https://github.com/evoluindocomia/antigravity-aiox-antigravity.git
cd aiox-antigravity
...
O framework de linguagem natural do AIOX funciona em QUALQUER domínio. Os Squads fornecem agentes IA especializados para escrita criativa, estratégia de negócios, saúde e bem-estar, educação e muito mais. Além disso, os Squads podem expandir o núcleo do AffHub AIOX com funcionalidade específica que não é genérica para todos os casos. [Veja o Guia de Squads](docs/guides/squads-guide.md) e aprenda a criar os seus próprios!

## Agentes Disponíveis

O AffHub AIOX vem com 11 agentes especializados:
...
O AffHub AIOX introduz o **Autonomous Development Engine (ADE)** - um sistema completo para desenvolvimento autônomo que transforma requisitos em código funcional.
...
| **2** | Migration V2→V3  | Migração para formato autoAntigravity V3        |
...
- **[hybrid-ops](https://github.com/AffHub/aiox-hybrid-ops-pedro-valerio)** - Operações híbridas humano-agente (repositório separado)

## AIOX Pro

O **AIOX Pro** (`@aiox-antigravity/pro`) é o módulo premium do AffHub AIOX, oferecendo funcionalidades avançadas para equipes e projetos de maior escala.

> **Disponibilidade restrita:** O AIOX Pro está disponível exclusivamente para membros do **AIOX Cohort Advanced**. [Saiba mais sobre o programa](https://antigravity.ai).

### Instalação

```bash
npm install @aiox-antigravity/pro
```
...
Para mais informações, execute `npx aiox-antigravity pro --help` após a instalação.

## Suporte

- 🐛 [Rastreador de Issues](https://github.com/evoluindocomia/antigravity-aiox-antigravity/issues) - Bug reports e feature requests
...
O Aiox-Antigravity implementa um sistema de validação de múltiplas camadas para garantir qualidade do código e consistência:
...
# Validador AIOX
node .aiox-antigravity/utils/aiox-validator.js pre-commit   # Validação pre-commit
node .aiox-antigravity/utils/aiox-validator.js pre-push     # Validação pre-push
node .aiox-antigravity/utils/aiox-validator.js stories      # Validar todas stories
```
...
**Note:** Some contributors shown in the GitHub contributors graph are inherited from the original BMad Method git history and do not represent active participation in or endorsement of AffHub AIOX.

[![Contributors](https://contrib.rocks/image?repo=AffHub/aiox-antigravity)](https://github.com/evoluindocomia/antigravity-aiox-antigravity/graphs/contributors)

<sub>Construído com ❤️ para a comunidade de desenvolvimento assistido por IA</sub>

---

**[⬆ Voltar ao topo](#antigravity-aiox-framework-universal-de-agentes-ia-)**
