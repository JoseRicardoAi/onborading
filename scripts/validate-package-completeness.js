...
const REQUIRED_PATHS = [
  ...
  // Native Codex artifacts
  '.codex/CODEX.md',
  '.codex/agents/',
  '.codex/rules/',
  '.codex/skills/',
  '.codex/workflows/',
  // Shared runtime-unico artifacts
  '.synapse/manifest',
 ...
 */
const REQUIRED_BIN_ENTRIES = ['aiox', 'aiox-antigravity', 'aiox-minimal', 'aiox-graph'];
...
function getTarballContents() {
  try {
    ...
    try {
      ...
      // Text output has lines like "npm notice 1.2kB .antigravity/hooks/synapse-engine.cjs"
