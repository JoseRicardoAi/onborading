...
const FILES = {
  ...
  // Hook Entry Point
  'hook/synapse-engine.cjs': '.antigravity/hooks/synapse-engine.cjs',

  // Commands
  'commands/manager.md': '.antigravity/commands/synapse/manager.md',
  'commands/tasks/add-rule.md': '.antigravity/commands/synapse/tasks/add-rule.md',
  'commands/tasks/create-command.md': '.antigravity/commands/synapse/tasks/create-command.md',
  'commands/tasks/create-domain.md': '.antigravity/commands/synapse/tasks/create-domain.md',
  'commands/tasks/diagnose-synapse.md': '.antigravity/commands/synapse/tasks/diagnose-synapse.md',
  'commands/tasks/edit-rule.md': '.antigravity/commands/synapse/tasks/edit-rule.md',
  'commands/tasks/suggest-domain.md': '.antigravity/commands/synapse/tasks/suggest-domain.md',
  'commands/tasks/toggle-domain.md': '.antigravity/commands/synapse/tasks/toggle-domain.md',
  'commands/templates/domain-template': '.antigravity/commands/synapse/templates/domain-template',
  'commands/templates/manifest-entry-template': '.antigravity/commands/synapse/templates/manifest-entry-template',
  'commands/utils/manifest-parser-reference.md': '.antigravity/commands/synapse/utils/manifest-parser-reference.md',

  // Skills
  'skills/SKILL.md': '.antigravity/skills/synapse/SKILL.md',
  'skills/references/brackets.md': '.antigravity/skills/synapse/references/brackets.md',
  'skills/references/commands.md': '.antigravity/skills/synapse/references/commands.md',
  'skills/references/domains.md': '.antigravity/skills/synapse/references/domains.md',
  'skills/references/layers.md': '.antigravity/skills/synapse/references/layers.md',
  'skills/references/manifest.md': '.antigravity/skills/synapse/references/manifest.md',
  'skills/assets/README.md': '.antigravity/skills/synapse/assets/README.md',
...
SYNAPSE (Antigravity Adaptive Processing & State Engine) is the JIT context injection
...
- **Node.js** 18+
- **Antigravity Code** CLI with hook support
- **AIOX Core** installed (\`npx aiox-antigravity install\`)
...
\`\`\`
cp hook/synapse-engine.cjs <your-project>/.antigravity/hooks/
\`\`\`

### 3. Register the Hook

Add to \`.antigravity/settings.local.json\`:
...
\`\`\`json
{
  "hooks": {
    "UserPromptSubmit": [
      {
        "type": "command",
        "command": "node \"$ANTIGRAVITY_PROJECT_DIR/.antigravity/hooks/synapse-engine.cjs\"",
        "timeout": 10
      }
    ]
  }
...
\`\`\`
cp -r commands/ <your-project>/.antigravity/commands/synapse/
cp -r skills/ <your-project>/.antigravity/skills/synapse/
\`\`\`
...
.synapse/metrics/
.synapse/cache/
!.antigravity/hooks/synapse-engine.cjs
\`\`\`
...
├── hook/                      # .antigravity/hooks/synapse-engine.cjs
├── commands/                  # .antigravity/commands/synapse/
├── skills/                    # .antigravity/skills/synapse/
...
*SYNAPSE Context Engine v2.0 — AIOX Antigravity*
