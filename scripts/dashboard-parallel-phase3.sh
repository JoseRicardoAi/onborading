...
declare -a STORIES=(
    ...
    "0.5|Status Bar|docs/stories/aiox-dashboard/epic-0-foundation.md|apps/dashboard/src/components/layout/|Create StatusBar.tsx showing auth, rate limit, antigravity status, active agent"
...
echo -e "   ${GREEN}✓${NC} Antigravity launched"
