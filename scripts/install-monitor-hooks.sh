...
#
# This script installs the AIOX monitor hooks into ~/.antigravity/hooks/
# The hooks capture Antigravity Code events and send them to the monitor server.
#
...
HOOKS_TARGET="$HOME/.antigravity/hooks"
...
echo "║                                                                ║"
echo "║  3. Start using Antigravity Code - events will be captured!         ║"
echo "╚════════════════════════════════════════════════════════════════╝"
