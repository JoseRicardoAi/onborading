...
Rules são arquivos `.md` que o Antigravit injeta no contexto dos agentes. Diferente do Antigravity Code (onde eram todas sempre carregadas), no Antigravit as rules podem ser **condicionais por path** — elas só se tornam ativas quando o agente está trabalhando em arquivos relacionados.
...
| `governance.md`           | **NOVO** | Substitui 6 hooks Python do Antigravity — checklist pré-operação      |
...
| Camada       | Path                                    | Regra                 |
| ------------ | --------------------------------------- | --------------------- |
| L1 Core      | `.aiox-core/core/`, `bin/aiox.js`       | NUNCA modificar       |
| L2 Templates | `.aiox-core/development/`               | NUNCA modificar       |
| L3 Config    | `.aiox-core/data/`, `MEMORY.md`         | Modificar com cuidado |
...
Substitui os **6 hooks Python** do Antigravity Code por um sistema instrucional de verificações obrigatórias gerenciado pela skill de governança, formando o AGP (AIOX Governance Pipeline).
